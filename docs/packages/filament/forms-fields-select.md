...
```
![Select](/docs/3.x/images/light/forms/fields/select/simple.jpg) ![Select](/docs/3.x/images/dark/forms/fields/select/simple.jpg)
...
```
![JavaScript select](/docs/3.x/images/light/forms/fields/select/javascript.jpg) ![JavaScript select](/docs/3.x/images/dark/forms/fields/select/javascript.jpg)
...
```
![Searchable select](/docs/3.x/images/light/forms/fields/select/searchable.jpg) ![Searchable select](/docs/3.x/images/dark/forms/fields/select/searchable.jpg)
...
```
![Multi-select](/docs/3.x/images/light/forms/fields/select/multiple.jpg) ![Multi-select](/docs/3.x/images/dark/forms/fields/select/multiple.jpg)
...
```
![Grouped select](/docs/3.x/images/light/forms/fields/select/grouped.jpg) ![Grouped select](/docs/3.x/images/dark/forms/fields/select/grouped.jpg)
...
```
![Select with create option button](/docs/3.x/images/light/forms/fields/select/create-option.jpg) ![Select with create option button](/docs/3.x/images/dark/forms/fields/select/create-option.jpg)
...
![Select with create option modal](/docs/3.x/images/light/forms/fields/select/create-option-modal.jpg) ![Select with create option modal](/docs/3.x/images/dark/forms/fields/select/create-option-modal.jpg)
...
```
![Select with edit option button](/docs/3.x/images/light/forms/fields/select/edit-option.jpg) ![Select with edit option button](/docs/3.x/images/dark/forms/fields/select/edit-option.jpg)
...
![Select with edit option modal](/docs/3.x/images/light/forms/fields/select/edit-option-modal.jpg) ![Select with edit option modal](/docs/3.x/images/dark/forms/fields/select/edit-option-modal.jpg)
...
```
![Select with affixes](/docs/3.x/images/light/forms/fields/select/affix.jpg) ![Select with affixes](/docs/3.x/images/dark/forms/fields/select/affix.jpg)
...
```
![Select with suffix icon](/docs/3.x/images/light/forms/fields/select/suffix-icon.jpg) ![Select with suffix icon](/docs/3.x/images/dark/forms/fields/select/suffix-icon.jpg)
