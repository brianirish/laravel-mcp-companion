...
#footer > div > div:nth-of-type(n+2) {
    display: none;
}On this pageSelect FiltersBoolean FiltersDate FiltersFilter TitlesFilter Default ValuesDynamic FiltersFiltersDefining FiltersNova filters are simple classes that allow you to scope your Nova index queries with custom conditions.Nova filters are simple classes that allow you to scope your Nova index queries with custom conditions.
...
public function apply(NovaRequest $request, Builder $query, mixed $value): Builder
{
    /** @var array{admin: bool, editor: bool} 