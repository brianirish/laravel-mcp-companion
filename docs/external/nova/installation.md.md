# Nova - Installation.Md

*Source: https://nova.laravel.com/docs/v5/installation.md*
...
NOVA_LICENSE_KEY=
```
```php config/nova.php theme={null}
...
```shell GitHub Actions theme={null}
...
```php app/Providers/NovaServiceProvider theme={null}
/**
