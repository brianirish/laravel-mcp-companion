...
On this pageIntroductionServer TypesApp ServersWeb ServersDatabase ServersCache ServersWorker ServersMeilisearch ServersLoad BalancersServersServer TypesLearn about the different types of servers you can provision with Forge.​Introduction
...
Once provisioned you may configure your load balancer to meet your needs.Was this page helpful?YesNoServer ProvidersManagementAssistantResponses are generated using AI and may contain mistakes.Laravel Forge home pagexgithubdiscordlinkedinTerm of ServicePrivacy PolicyData Processing Agreement (DPA)xgithubdiscordlinkedin(self.__next_f=self.__next_f||[]).push([0])self