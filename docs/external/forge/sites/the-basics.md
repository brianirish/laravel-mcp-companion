...
- [Apps / Projects](#apps-%2F-projects)
...
- [Changing A Site’s Installed PHP Version](#changing-a-site%E2%80%99s-installed-php-version)
- [Site Logs](#site-logs)
- [Logrotate](#logrotate)
...
When you are ready to transition your application to an official domain name, you may rename the site in the **Settings** tab of the site’s management panel. After renaming the site, you will no longer be able to access it using the server’s IP address. After renaming the site, you should add a DNS `A` record for the domain that points to
