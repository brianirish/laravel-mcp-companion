...
## [​](#laravel-scheduler) Laravel Scheduler
You may quickly enable or disable the Laravel scheduler via the “Laravel Scheduler” toggle. Laravel Forge will create the required [Scheduler](/forge/docs/resources/scheduler) for you.
...
Once your preferred server has been provisioned, you should [add a new site](/forge/docs/sites/the-basics#creating-sites) and [install your Reverb-enabled Laravel application](/forge/docs/sites/the-basics#apps-projects) from your version control provider of choice.
